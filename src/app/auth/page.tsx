      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-6">
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link href="/public/terms" className="text-primary hover:underline">Syarat & Ketentuan</Link>
            {' '}dan{' '}
            <Link href="/public/privacy" className="text-primary hover:underline">Kebijakan Privasi</Link>
          </p>
