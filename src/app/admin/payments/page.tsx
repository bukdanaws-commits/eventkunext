...
import { Loader2, Search, RefreshCw, DollarSign, Clock, CheckCircle, XCircle, AlertCircle, Download, CheckCheck, Building2, Image, ExternalLink, Ban, Timer, BarChart3, FileText } from 'lucide-react';
...
export default function AdminPayments() {
  ...
  const handleRefund = async () => {
    ...
    try {
      ...
      // Update event status back to pending_payment
      await supabase
        .from('events')
  ...
  const handleVerifyManualPayment = async () => {
    ...
    try {
      ...
      // Update event status to active and apply tier
      await supabase
        .from('events')
        .update({ 
          status: 'active', 
  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        ...
        {/* Tabs for All Payments, Monitoring, and Analytics */}
                ...
                {filteredPayments.length === 0 ? (
                  ...
                  filteredPayments.map((payment) => (
                    <TableRow key={payment.id}>
                      ...
                      <TableCell>
                        {/* Inline proof thumbnail for manual transfers */}
                      ...
                      <TableCell className="space-x-1">
                        {/* Verify and Reject buttons for pending manual transfers */}
                        ...
                        {/* Retry button for failed/expired payments */}
