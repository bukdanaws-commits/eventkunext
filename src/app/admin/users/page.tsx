...
export default function AdminUsers() {
  ...
  const fetchUsers = useCallback(async () => {
    ...
    try {
      ...
      const enrichedUsers: UserWithDetails[] = await Promise.all(
        (profiles || []).map(async (profile) => {
          ...
          return {
            ...
            email: profile.email || 'No email', // Email now comes from user_profiles table
          };
        })
      );
      ...
      // Try to handle auth errors with retry
  ...
  // Duplicate function removed - using useCallback version above
  ...
  const handleBlockUser = async () => {
    ...
    try {
      if (isCurrentlyBlocked) {
        // Unblock - update existing record
        const { error } = await supabase
          .from('blocked_users')
        ...
        toast({
          ...
          description: `${selectedUser.full_name || selectedUser.email} berhasil di-unblock`,
        });
      } else {
        ...
        toast({
          title: 'User Blocked',
          description: `${selectedUser.full_name || selectedUser.email} berhasil diblokir`,
        });
      }

      setUsers(prev =>
        prev.map(u => u.user_id === selectedUser.user_id ? { ...u, is_blocked: !isCurrentlyBlocked } : u)
      );
      ...
      toast({
        variant: 'destructive',
        title: 'Error',
        description: 'Gagal mengubah status block user',
      });
    } finally {
      setBlocking(false);
    }
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      ...
      toast({
        title: 'User Dihapus',
        description: `${selectedUser.full_name || selectedUser.email} berhasil dihapus`,
      });
    ...
    try {
      ...
      await logAction({
        ...
        details: {
          ...
          new_name: editFullName,
          previous_phone: selectedUser.phone,
          new_phone: editPhone,
        },
      });
      ...
      setUsers(prev =>
        prev.map(u => u.user_id === selectedUser.user_id 
          ? { ...u, full_name: editFullName, phone: editPhone } 
          : u
        )
      );
      ...
      toast({
        ...
        description: 'Profile user berhasil diperbarui',
      });
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Password untuk ${selectedUser.full_name || selectedUser.email} berhasil diubah`,
      });
      ...
      toast({
        variant: 'destructive',
        title: 'Error',
        description: error instanceof Error ? error.message : 'Gagal reset password',
      });
    } finally {
    ...
    try {
      ...
      for (const userToBlock of usersToBlock) {
        ...
        await logAction({
          action: 'user_blocked',
          targetType: 'user',
          targetId: userToBlock.user_id,
          details: {
            user_name: userToBlock.full_name,
      ...
      toast({
        title: 'Users Diblokir',
        description: `${usersToBlock.length} user berhasil diblokir`,
      });
      ...
      toast({
        variant: 'destructive',
        title: 'Error',
        description: 'Gagal memblokir users',
      });
    } finally {
  ...
  const handleBulkDelete = async () => {
    ...
    try {
      ...
      toast({
        variant: 'destructive',
        title: 'Error',
        description: 'Gagal menghapus users',
      });
    } finally {
      setBulkProcessing(false);
    }
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <Card className="bg-gradient-to-br from-red-50 to-pink-50 dark:from-red-950 dark:to-pink-950 border-red-200 dark:border-red-800">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-red-700 dark:text-red-300">{adminCount}</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-950 dark:to-violet-950 border-purple-200 dark:border-purple-800">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-purple-700 dark:text-purple-300">{ownerCount}</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950 dark:to-teal-950 border-emerald-200 dark:border-emerald-800">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-emerald-700 dark:text-emerald-300">{totalOrgs}</div>
            </CardContent>
          </Card>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-4">
                <div className="relative flex-1 min-w-[200px]">
                  ...
                  <Input
                    placeholder="Cari nama, email, atau organization..."
                    value={searchQuery}
                      ...
                      <TableCell>
                        <div className="flex gap-1">
                          ...
                          <Button
                            variant="outline"
                            size="icon"
                            className={`h-8 w-8 ${user.is_blocked ? 'text-green-600 hover:text-green-700 hover:bg-green-50' : 'text-orange-600 hover:text-orange-700 hover:bg-orange-50'}`}
                            onClick={() => {
                              setSelectedUser(user);
                              setBlockReason('');
              ...
              <div className="mt-6 space-y-6">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{selectedUser.event_count}</p>
                  </div>
                  <div>
        ...
        <Dialog open={roleDialogOpen} onOpenChange={setRoleDialogOpen}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Ubah role untuk user: {selectedUser?.full_name || 'Unknown'}
              </DialogDescription>
            </DialogHeader>
            <div className="py-4">
        ...
        <Dialog open={addUserDialogOpen} onOpenChange={setAddUserDialogOpen}>
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Buat akun user baru. User akan otomatis ter-verifikasi.
              </DialogDescription>
            </DialogHeader>
        ...
        <AlertDialog open={blockDialogOpen} onOpenChange={setBlockDialogOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                {selectedUser?.is_blocked 
                  ? `Apakah Anda yakin ingin unblock ${selectedUser?.full_name || selectedUser?.email}? User akan dapat mengakses sistem kembali.`
                  : `Apakah Anda yakin ingin memblokir ${selectedUser?.full_name || selectedUser?.email}? User tidak akan dapat mengakses sistem.`
                }
              </AlertDialogDescription>
            </AlertDialogHeader>
            {!selectedUser?.is_blocked && (
              <div className="py-4">
                <Label htmlFor="blockReason">Alasan Block</Label>
                <Textarea
                  id="blockReason"
        ...
        <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Apakah Anda yakin ingin menghapus <strong>{selectedUser?.full_name || selectedUser?.email}</strong>? 
        ...
        <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Edit profile untuk {selectedUser?.full_name || selectedUser?.email}
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              <div className="grid gap-2">
        ...
        <Dialog open={resetPasswordDialogOpen} onOpenChange={setResetPasswordDialogOpen}>
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              ...
              <DialogDescription>
                Reset password untuk {selectedUser?.full_name || selectedUser?.email}
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              <div className="grid gap-2">
        ...
        <AlertDialog open={bulkBlockDialogOpen} onOpenChange={setBulkBlockDialogOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle className="flex items-center gap-2">
                <Ban className="h-5 w-5 text-orange-600" />
                Block {selectedUsers.size} Users
              </AlertDialogTitle>
              <AlertDialogDescription>
                Apakah Anda yakin ingin memblokir {selectedUsers.size} user? User yang sudah diblokir akan dilewati.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <div className="py-4">
              <Label htmlFor="bulkBlockReason">Alasan Block</Label>
              <Textarea
                id="bulkBlockReason"
                placeholder="Masukkan alasan pemblokiran..."
        ...
        <AlertDialog open={bulkDeleteDialogOpen} onOpenChange={setBulkDeleteDialogOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle className="flex items-center gap-2 text-red-600">
                <AlertTriangle className="h-5 w-5" />
                Hapus {selectedUsers.size} Users
              </AlertDialogTitle>
              <AlertDialogDescription>
                Apakah Anda yakin ingin menghapus {selectedUsers.size} user? 
