...
import { 
  ...
  TrendingUp, Activity, CheckCircle2, XCircle, Wifi
} from 'lucide-react';
...
function EventAttendanceMonitorContent({ event }: EventContextValue) {
  ...
  }, [event.id, soundEnabled, playCheckinSound]);
...
export default function EventAttendanceMonitor() {
  return (
    <EventLayout>
      {(props) => <EventAttendanceMonitorContent {...props} />}
    </EventLayout>
  );
}
